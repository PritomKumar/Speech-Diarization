...
from diart.sources import MicrophoneAudioSource, WebSocketAudioSource
    ...
    def transcribe(self, waveform):
        ...
        with suppress_stdout():
            transcription = whisper.transcribe(
                ...
                language="es" # to specify the language
            )
...
source = WebSocketAudioSource(config.sample_rate) #source = MicrophoneAudioSource(config.step)
